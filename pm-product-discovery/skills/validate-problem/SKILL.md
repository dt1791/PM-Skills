...
description: >
  Rigorously validate a problem statement before any solution or ideation 
  work begins. Use this skill FIRST — before /discover, before brainstorming, 
  before any solution thinking. Trigger whenever the user has a new product 
  idea, a problem they want to solve, or is about to start discovery. Also 
  trigger when the user says things like "I want to build X", "I'm thinking 
  of creating X", "help me validate this idea", "is this a real problem", 
  or "where should I start". This is Stage 0 of the PM process. Do not skip it.
---
